...
export const LiveEventCard: FC<LiveEventCardProps> = ({event, products, onDeleteAction, onFinishedEventAction}) => {
    return (
        <Card title={event.title}
              primaryFooterAction={{content: '이벤트 종료하기', onAction: async () => {await onFinishedEventAction(event.id)}}}
